...
#define EXPECTED_WORLDSERVER_CLIENT_BUILD        { 5464, 0}
#elif SUPPORTED_CLIENT_BUILD == CLIENT_BUILD_1_10_2
#define EXPECTED_WORLDSERVER_CLIENT_BUILD        { 5302, 0}
#elif SUPPORTED_CLIENT_BUILD == CLIENT_BUILD_1_9_4
#define EXPECTED_WORLDSERVER_CLIENT_BUILD        { 5086, 0}
#elif SUPPORTED_CLIENT_BUILD == CLIENT_BUILD_1_8_4
#define EXPECTED_WORLDSERVER_CLIENT_BUILD        { 4878, 0}
#elif SUPPORTED_CLIENT_BUILD == CLIENT_BUILD_1_7_1
#define EXPECTED_WORLDSERVER_CLIENT_BUILD        { 4695, 0}
#elif SUPPORTED_CLIENT_BUILD == CLIENT_BUILD_1_6_1
#define EXPECTED_WORLDSERVER_CLIENT_BUILD        { 4544, 4565, 4620, 0}
#elif SUPPORTED_CLIENT_BUILD == CLIENT_BUILD_1_5_1
#define EXPECTED_WORLDSERVER_CLIENT_BUILD        { 4449, 0}
#elif SUPPORTED_CLIENT_BUILD == CLIENT_BUILD_1_4_2
#define EXPECTED_WORLDSERVER_CLIENT_BUILD        { 4375, 0}
#elif SUPPORTED_CLIENT_BUILD == CLIENT_BUILD_1_3_1
#define EXPECTED_WORLDSERVER_CLIENT_BUILD        { 4297, 0}
#else
#define EXPECTED_WORLDSERVER_CLIENT_BUILD        { 4222, 0}
#endif
