...
static constexpr uint16 holetab_h[4] = { 0x1111, 0x2222, 0x4444, 0x8888 };
static constexpr uint16 holetab_v[4] = { 0x000F, 0x00F0, 0x0F00, 0xF000 };
...
bool GridMap::isHole(int row, int col) const
{
    ...
    const uint16 hole = m_holes[cellRow][cellCol];
